...
const API_URL = 'http://192.168.18.32:4000/live'; 
const HOURLY_URL = 'http://192.168.18.32:4000/hourly'; 
const DAILY_URL = 'http://192.168.18.32:7000/daily'; 
...
export default function App() {
  ...
  return (
    ...
    <ScrollView style={styles.container}>
      <Text style={styles.title}>SenseHAT Data</Text>
